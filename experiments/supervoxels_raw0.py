...
source_filepath = '/g/schwab/eckstein/code/models/unet3d_tomo/cluster/piled_unet_14_run2_new_gt/predictions/reshaped_prediction_raw_0_result0150.h5'
target_filepath = f'{target_folder}raw_0_result0150_3.h5'
source_in_file = 'data'
