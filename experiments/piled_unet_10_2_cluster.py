...
filepath_mask_3 = f'/scratch/eckstein/input_data/gt/raw_gt_mask_new_annotation/block_3/no_mask_golgi/mem_gt_mask_block_3.h5'
...
writer = SummaryWriter(
    '/g/schwab/eckstein/scripts/tensorboard/piled_unet_10_run2' + datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
                ...
                if val_loe:
                    ...
                    if best_val_loss is None or val_loss < best_val_loss:
                        ...
                        torch.save(network.state_dict(),
                                   f'/scratch/eckstein/models/piled_unet_10_run2/result{epoch:04d}.h5')
                    break
