...
loss = CombinedLosses(losses=(
        ...
        WeightMatrixWeightedBCELoss(((0.3, 0.7),), weigh_with_matrix_sum=False)),
            ...
            for x_val, y_val, val_epoch, val_n, val_loe in val_gen:
                ...
                if val_loe:
                    ...
                    if best_val_loss is None or val_loss < best_val_loss:
                        ...
                        torch.save(network.state_dict(), f'/g/schwab/eckstein/code/models/unet3d_tomo/piled_unet_1/result{epoch:04d}.h5')
                    break
