...
writer = SummaryWriter(
    '/g/schwab/eckstein/scripts/tensorboard/piled_unet_25_run2' + datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
            ...
            for x_val, y_val, val_epoch, val_n, val_loe in val_gen:
                ...
                if val_loe:
                    ...
                    if best_val_loss is None or val_loss < best_val_loss:
                        ...
                        torch.save(network.state_dict(), f'/scratch/eckstein/models/piled_unet_25_run2/result{epoch:04d}.h5')
                    break
