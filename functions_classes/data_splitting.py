...
filepath_gt_channels = '/g/schwab/eckstein/gt/original_raw_gt_mask/mem_gt.h5'
filepath_mask = '/g/schwab/eckstein/gt/data_dilated_mask_20/mem_gt_mask_int.h5'

#result_folder_raw ='/g/schwab/eckstein/gt/data_split/'
#result_folder_gt =
result_folder_mask = '/g/schwab/eckstein/gt/data_split/mask_split_dilate_20/'
